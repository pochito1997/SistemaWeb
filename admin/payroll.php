...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <!-- Contenido de Encabezado(Page header) -->
            ...
            <div class="box-header with-border">
              <div class="pull-right">
                <form method="POST" class="form-inline" id="payForm">
                  ...
                  <button type="button" class="btn btn-success btn-sm btn-flat" id="payroll"><span class="glyphicon glyphicon-print"></span> Rol de Pago</button>
                  <button type="button" class="btn btn-primary btn-sm btn-flat" id="payslip"><span class="glyphicon glyphicon-print"></span> Lista de Pago</button>
                </form>
              </div>
            </div>
            <div class="box-body">
